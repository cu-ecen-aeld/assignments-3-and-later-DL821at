...
struct thread_data{
    ...
    int wait_to_release_ms;          // Time to wait after obtaining the mutex before releasing it
    bool thread_complete_success;    // Set to true if the thread completed successfully, false if an error occurred
};
